...
<body class="flex flex-col min-h-screen bg-gray-100">
 <!-- Header Start -->
  <header class="bg-blue-500 text-white">
    <div class="flex item-center flex justify-between container mx-auto p-4">
    ...
    <div class="mt-8 space-y-4">
        <!-- Card Header Start -->
         <div class="bg-white shadow p-4 rounded-lg">
            ...
            <p>Menamabahkan siswa baru ke dalam sistem</p>
         </div>
        <!-- Card Header End -->
        ...
        <div class="bg-white rounded-lg shadow">
            <form action="" class="p-4 grid grid-cols-2 gap-4">
                ...
                <div class="space-y-4">
                    ...
                    <input class="px-4 py-2 border rounded-lg w-full" type="text" id="phone-number" name="phone-number" placeholder="Masukkan No Telepon">
                </div>
